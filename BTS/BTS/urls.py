...
urlpatterns = [
    ...
    path('managerHome/deleteProject/<int:project_id>/', authentication.views.delete_project, name='deleteProject'),
    path('managerHome/deleteBug/<int:bug_id>/', authentication.views.delete_bug, name='deleteBug'),
